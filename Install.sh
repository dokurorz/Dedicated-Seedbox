...
source <(wget -qO- https://raw.githubusercontent.com/iniwex5/Seedbox-Components/main/Miscellaneous/tput.sh)
...
source <(wget -qO- https://raw.githubusercontent.com/iniwex5/Seedbox-Components/main/seedbox_installation.sh)
Update
...
source <(wget -qO- https://raw.githubusercontent.com/iniwex5/Seedbox-Components/main/tweaking.sh)
CPU_Tweaking
NIC_Tweaking
